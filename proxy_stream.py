"""
ShadowEngine — Local API Proxy (Streaming)

Run this on your local machine to route local API requests to your Kaggle GPU.
This version utilizes chunked transfer encoding (stream=True) to deliver 
tokens in real-time, making it ideal for chat UIs and lowering TTFT.
